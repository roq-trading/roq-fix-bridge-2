...
def logon_request():
    ...
    msg.append_pair(98, '0')  # encrypt method
    msg.append_pair(108, 10)  # heartbt int
...
def new_order_single_request(cl_ord_id):
    ...
    msg.append_pair(44, 30000.0)  # price
...
def request_for_positions_request():
    ...
    msg.append_pair(56, TARGET_COMP_ID)
    msg.append_pair(1, ACCOUNT)
    # msg.append_pair(207, 'binance')  # exchange
    # msg.append_pair(55, 'BTC')  # symbol
    msg.append_pair(15, 'BTC')  # currency
